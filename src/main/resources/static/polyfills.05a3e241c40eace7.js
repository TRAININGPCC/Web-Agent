"use strict";
(self.webpackChunktts_webagent_web = self.webpackChunktts_webagent_web || []).push([[461], {
    6935: () => {
        const te = globalThis;
        function ee(e) {
        ...
        const qe = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope
          ...
          , Ve = !Re && !qe && !(!Pe || !Te.HTMLElement)
          , Xe = typeof $.process < "u" && "[object process]" === $.process.toString() && !qe && !(!Pe || !Te.HTMLElement)
          , Ce = {}
          ...
          , Ye = function(e) {
            ...
            const c = this || e.target || $
              , t = c[r];
            let i;
            return Ve && c === Te && "error" === e.type ? (i = t && t.call(this, e.message, e.filename, e.lineno, e.colno, e.error),
            !0 === i && e.preventDefault()) : (i = t && t.apply(this, arguments),
            "beforeunload" === e.type && $[yt] && "string" == typeof i ? e.returnValue = i : null != i && !i && e.preventDefault()),
            i
        };
        function $e(e, r, c) {
            let t = ke(e, r);
            ...
            t.set = function(D) {
                let d = this;
                !d && e === $ && (d = $),
                d && ("function" == typeof d[m] && d.removeEventListener(T, Ye),
                E && E.call(d, null),
                d[m] = D,
            ...
            t.get = function() {
                ...
                if (u) {
                    ...
                    if (P)
                        ...
                        "function" == typeof D[Tt] && D.removeAttribute(r),
                        P
                }
                return null
            }
        ...
        function be(e) {
            ...
            let t;
            for (t in c)
                "XMLHttpRequest" === e && "responseBlob" === t || function(i) {
                    "function" == typeof c[i] ? $[e].prototype[i] = function() {
                        return this[re][i].apply(this[re], arguments)
                    }
                    : Ne($[e].prototype, i, {
                        set: function(u) {
                            "function" == typeof u ? (this[re][i] = je(u, e + "." + i),
                            fe(this[re][i], u)) : this[re][i] = u
                        },
                        get: function() {
                            return this[re][i]
                        }
        ...
        function ue(e, r, c) {
            ...
            const i = j(r);
            let u = null;
            if (t && (!(u = t[i]) || !t.hasOwnProperty(i)) && (u = t[i] = t[r],
            We(t && ke(t, r)))) {
                const T = c(u, i, r);
                t[r] = function() {
        ...
        function mt(e, r, c) {
            ...
            t = ue(e, r, u => function(E, T) {
                const m = c(E, T);
                return m.cbIdx >= 0 && "function" == typeof T[m.cbIdx] ? He(m.name, T[m.cbIdx], m, i) : u.apply(E, T)
            }
            )
        }
        function fe(e, r) {
        ...
        function bt(e, r, c, t) {
            const i = t && t.add || Ie
              ...
              , Z = function(k, h, H) {
                ...
                const V = k.callback;
                let Y;
                "object" == typeof V && V.handleEvent && (k.callback = g => V.handleEvent(g),
                ...
                const G = k.options;
                return G && "object" == typeof G && G.once && h[u].call(h, H.type, k.originalDelegate ? k.originalDelegate : k.callback, G),
                Y
            };
            function x(k, h, H) {
                if (!(h = h || e.event))
            ...
            function K(k, h) {
                ...
                const q = H ? function(s) {
                    if (!O.isExisting)
                        return R.call(O.target, O.eventName, O.capture ? J : U, O.options)
                }
                : function(s) {
                        ...
                        if (C)
                            for (let y = 0; y < C.length; y++)
                                if (C[y] === s) {
                                    ...
                                    0 === C.length && (s.allRemoved = !0,
                                    s.target[v] = null);
                                    break
                                }
                    }
                    if (s.allRemoved)
                        return b.call(s.target, s.eventName, s.capture ? J : U, s.options)
                }
                : function(s) {
                    ...
                    return function() {
                        ...
                        const Ee = ge && !!oe && -1 !== oe.indexOf(M)
                          , ie = function f(s) {
                            ...
                            return !ge && "object" == typeof s && s ? !!s.capture : ge && l ? "boolean" == typeof s ? {
                                capture: s,
                                passive: !0
                        ...
                        if (de)
                            for (let ce = 0; ce < de.length; ce++)
                                if (M === de[ce])
                                    return Ee ? s.call(I, M, F, ie) : s.apply(this, arguments);
                        ...
                        O.eventName = M,
                        O.isExisting = ft;
                        const we = H ? vt : void 0;
                        we && (we.taskData = O),
                        me && (O.options.signal = void 0);
                        const se = At.scheduleEventTask(Se, F, we, v, C);
                        if (me) {
                            O.options.signal = me;
                            ...
                            se.removeAbortListener = () => me.removeEventListener("abort", ce)
                        }
                ...
                return g[i] = a(R, D, q, A, G),
                W && (g[d] = a(W, P, function(s) {
                    ...
                    if (M)
                        for (let F = 0; F < M.length; F++) {
                            ...
                            if (he(B, y))
                                return M.splice(F, 1),
                                B.isRemoved = !0,
                                0 !== M.length || (B.allRemoved = !0,
                                s[I] = null,
                                C || "string" != typeof l) || (s[ve + "ON_PROPERTY" + l] = null),
                                B.zone.cancelTask(B),
                                G ? s : void 0
                        }
                    return b.apply(this, arguments)
        ...
        function ye(e, r, c, t) {
            ...
            function T(D) {
                ...
                ;
                const P = i.apply(e, d.args);
                return et(P) ? d.handleId = P : (d.handle = P,
                d.isRefreshable = Qe(P.refresh)),
                D
            }
            function m(D) {
                const {handle: d, handleId: P} = D.data;
                return u.call(e, d ?? P)
            }
            i = ue(e, r += t, D => function(d, P) {
                if (Qe(P[0])) {
                    const Z = {
                        isRefreshable: !1,
                        isPeriodic: "Interval" === t,
                        delay: "Timeout" === t || "Interval" === t ? P[1] || 0 : void 0,
                        args: P
                    }
                      , x = P[0];
                    P[0] = function() {
                    ...
                    X && !k)) {
                        ...
                        K.refresh = function() {
                            ...
                            return "notScheduled" === V ? (U._state = "scheduled",
                            H._updateTaskCount(U, 1)) : "running" === V && (U._state = "scheduling"),
                            h.call(this)
                        }
                    }
                    return K ?? J ?? U
            ...
            u = ue(e, c, D => function(d, P) {
                const Z = P[0];
                let x;
                et(Z) ? (x = E[Z],
                delete E[Z]) : (x = Z?.[De],
                x ? Z[De] = null : x = Z),
                x?.type ? x.cancelFn && x.zone.cancelTask(x) : D.apply(e, P)
            }
            )
        }
        function it(e, r, c) {
                ...
                return m && m.prototype && i.forEach(function(d) {
                    ...
                    try {
                        if (Z.hasOwnProperty(d)) {
                            ...
                            e._redefineProperty(m.prototype, d, x)) : Z[d] && (Z[d] = e.wrapWithCurrentZone(Z[d], P))
                        } else
                            Z[d] && (Z[d] = e.wrapWithCurrentZone(Z[d], P))
                    } catch {}
                }),
                E.call(r, T, m, D)
            }
        ...
        const at = function Oe() {
            ...
            return e.Zone ??= function ze() {
                    ...
                    class N {
                        ...
                        static __load_patch(n, o, p=!1) {
                            if (O.hasOwnProperty(n)) {
                                const w = !0 === te[ee("forceDuplicateZoneCheck")];
                                if (!p && w)
                        ...
                        wrap(n, o) {
                            ...
                            const p = this._zoneDelegate.intercept(this, n, o)
                              , w = this;
                            return function() {
                                return w.runGuarded(p, this, arguments, o)
                            }
                        }
                        run(n, o, p, w) {
                            b = {
                            ...
                            try {
                                return this._zoneDelegate.invoke(this, n, o, p, w)
                            } finally {
                                b = b.parent
                            }
                        }
                        runGuarded(n, o=null, p, w) {
                            b = {
                                parent: b,
                                zone: this
                            };
                        ...
                        runTask(n, o, p) {
                            ...
                            if (n.state === X && (q === z || q === g))
                                return;
                            const he = n.state != H;
                            he && w._transitionTo(H, h);
                            const de = S;
                            S = w,
                            b = {
                                parent: b,
                            ...
                            try {
                                ...
                                try {
                                    return this._zoneDelegate.invokeTask(this, w, o, p)
                                } catch (oe) {
                                    if (this._zoneDelegate.handleError(this, oe))
                                        throw oe
                                }
                            } finally {
                                const oe = n.state;
                                if (oe !== X && oe !== Y)
                                    if (q == z || A || _e && oe === k)
                                        he && w._transitionTo(h, H, k);
                                    else {
                                        const f = w._zoneDelegates;
                                        this._updateTaskCount(w, -1),
                                        he && w._transitionTo(X, H, X),
                                        _e && (w._zoneDelegates = f)
                                    }
                                b = b.parent,
                                S = de
                            }
                        ...
                        scheduleMicroTask(n, o, p, w) {
                            return this.scheduleTask(new E(G,n,o,p,w,void 0))
                        }
                        scheduleMacroTask(n, o, p, w, q) {
                            return this.scheduleTask(new E(g,n,o,p,w,q))
                        }
                        scheduleEventTask(n, o, p, w, q) {
                            return this.scheduleTask(new E(z,n,o,p,w,q))
                        }
                        cancelTask(n) {
                            if (n.zone != this)
                ...
                const i = {
                    ...
                    onInvokeTask: (N, _, n, o, p, w) => N.invokeTask(n, o, p, w),
                ...
                class u {
                    ...
                    constructor(_, n, o) {
                        ...
                        (p || n && n._hasTaskZS) && (this._hasTaskZS = p ? o : i,
                        this._hasTaskDlgt = n,
                    ...
                    invoke(_, n, o, p, w) {
                        return this._invokeZS ? this._invokeZS.onInvoke(this._invokeDlgt, this._invokeCurrZone, _, n, o, p, w) : n.apply(o, p)
                    }
                    handleError(_, n) {
                    ...
                    _updateTaskCount(_, n) {
                        ...
                        0 != p && 0 != w || this.hasTask(this._zone, {
                ...
                e.__load_patch("ZoneAwarePromise", (r, c, t) => {
                    ...
                    function N(f, a, s) {
                        ...
                        if (f[k] === g) {
                            ...
                            if (a !== O && s instanceof A && s.hasOwnProperty(k) && s.hasOwnProperty(h) && s[k] !== g)
                                n(s),
                                N(f, s[k], s[h]);
                                ...
                                a === O && s instanceof Error) {
                                    const y = c.currentTask && c.currentTask.data && c.currentTask.data[Z];
                                    y && u(s, W, {
                                        configurable: !0,
                                        enumerable: !1,
                                        writable: !0,
                    ...
                    function o(f, a, s, l, v) {
                        n(f);
                        const C = f[k]
                          , y = C ? "function" == typeof l ? l : K : "function" == typeof v ? v : X;
                        a.scheduleMicroTask(G, () => {
                            try {
                                ...
                                I && (s[V] = L,
                                s[Y] = C);
                                const M = a.run(y, void 0, I && y !== X && y !== K ? [] : [L]);
                                N(s, !0, M)
                            } catch (L) {
                                N(s, !1, L)
                            }
                    ...
                    class A {
                        ...
                        then(a, s) {
                            ...
                            const v = new l(w)
                              , C = c.current;
                            return this[k] == g ? this[h].push(C, v, a, s) : o(this, C, v, a, s),
                            v
                        }
                        catch(a) {
                            ...
                            l[H] = H;
                            const v = c.current;
                            return this[k] == g ? this[h].push(v, l, a, a) : o(this, v, l, a, a),
                            l
                        }
                    }
                    A.resolve = A.resolve,
                    ...
                    return t.patchThen = de,
                    _e && (de(_e),
                    ue(r, "fetch", f => function oe(f) {
                        return function(a, s) {
                            let l = f.apply(a, s);
                            if (l instanceof A)
                                return l;
                    ...
                    const c = Function.prototype.toString
                      ...
                      , E = function() {
                        if ("function" == typeof this) {
                            const d = this[t];
                            if (d)
                                return "function" == typeof d ? c.call(d) : Object.prototype.toString.call(d);
                            if (this === Promise) {
                                const P = r[i];
                                if (P)
                                    return c.call(P)
        ...
        function Ot(e) {
            ...
            //             return;
            //         const {eventNames: c, zoneSymbolEventNames: t, TRUE_STR: i, FALSE_STR: u, ZONE_SYMBOL_PREFIX: E} = r.getGlobalObjects();
            ...
            //     !function St(e, r) {
            //         if (Re && !Xe || Zone[e.symbol("patchEvents")])
            //             return;
            ...
            //         //         R && !0 === R[m] && !S.aborted && Q.state === X && Q.invoke()
            //         //     }
            //         // }
            //         // )
            ...
            e.__load_patch("PromiseRejectionEvent", (r, c) => {
                ...
                r.PromiseRejectionEvent && (c[j("unhandledPromiseRejectionHandler")] = t("unhandledrejection"),
